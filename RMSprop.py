...
RMSprop_dict_params = {'params': net.parameters(),
                       'lr': [0.001, 0.01, 0.1]}
...
#                                                        optimizers_list,
#                                                        optimizer_name_list):
optimizer_params = RMSprop_dict_params.copy()
for lr in RMSprop_dict_params['lr']:
    ...
    for batch_size in batch_sizes:
        ...
        optimizer = optim.RMSprop(**optimizer_params)
