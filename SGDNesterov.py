...
for lr in SGD_dict_params['lr']:
    for moment in [0.5, 0.9]:

        for batch_size in batch_sizes:

            net = ResNet18()
            optimizer_params = {'params': net.parameters(), 'lr': lr, 'momentum': moment, 'nesterov': True}
            ...
            optimizer_params_buf = removekey(optimizer_params_buf, 'nesterov')
